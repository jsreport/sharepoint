...
namespace SharePointAppWeb
{
    ...
    public abstract class SharePointContext
    {
        ...
        private static ClientContext CreateClientContext(Uri spSiteUrl, string accessToken)
        {
            ...
            {
                Trace.WriteLine("spSiteUrl != null && !string.IsNullOrEmpty(accessToken)");
    ...
    public abstract class SharePointContextProvider
    {
        ...
        public static RedirectionStatus CheckRedirectionStatus(HttpContextBase httpContext, out Uri redirectUrl)
        {
            ...
            if (!string.IsNullOrEmpty(httpContext.Request.QueryString[SPHasRedirectedToSharePointKey]))
            {
                ...
                Trace.WriteLine("SPHasRedirectedToSharePointKey should be null");
                return RedirectionStatus.CanNotRedirect;
            }
            ...
            if (spHostUrl == null)
            {
                Trace.WriteLine("spHostUrl is null");
                return RedirectionStatus.CanNotRedirect;
            }
            
            if (StringComparer.OrdinalIgnoreCase.Equals(httpContext.Request.HttpMethod, "POST"))
            {
                Trace.WriteLine("should be POST");
                return RedirectionStatus.CanNotRedirect;
            }
        ...
        public SharePointContext CreateSharePointContext(HttpRequestBase httpRequest)
        {
            ...
            if (string.IsNullOrEmpty(spLanguage))
            {
                Trace.WriteLine("spLanguage is null");
                return null;
            }
            ...
            if (string.IsNullOrEmpty(spClientTag))
            {
                Trace.WriteLine("spClientTag is null");
                return null;
            }
            ...
            if (string.IsNullOrEmpty(spProductNumber))
            {
                Trace.WriteLine("spProductNumber is null");
                return null;
            }
        ...
        public SharePointContext GetSharePointContext(HttpContextBase httpContext)
        {
            ...
            Trace.WriteLine("loading sharepoint context");
            SharePointContext spContext = LoadSharePointContext(httpContext);

            Trace.WriteLine("spcontext loaded " + spContext);
          
            if (spContext == null || !ValidateSharePointContext(spContext, httpContext))
            {
                Trace.WriteLine("creating context");
    ...
    public class SharePointAcsContextProvider : SharePointContextProvider
    {
        ...
        protected override SharePointContext CreateSharePointContext(Uri spHostUrl, Uri spAppWebUrl, string spLanguage, string spClientTag, string spProductNumber, HttpRequestBase httpRequest)
        {
            ...
            {
                Trace.WriteLine("contextTokenString is null");
                return null;
            }
            ...
            try
            {
                Trace.WriteLine("ReadAndValidateContextToken");
            ...
            catch (AudienceUriValidationFailedException e)
            {
                Trace.WriteLine(e.ToString());
                return null;
            }
