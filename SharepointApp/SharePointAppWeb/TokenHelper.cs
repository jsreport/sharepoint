...
namespace SharePointAppWeb
{
    public static class TokenHelper
    {
        ...
        public static ClientContext CreateAppEventClientContext(SPRemoteEventProperties properties, bool useAppWeb)
        {
            ...
            {
                Trace.WriteLine("AppEventProperties are null !!");
                return null;
            }
            ...
            if (IsHighTrustApp())
            {
                Trace.WriteLine("GetS2SClientContextWithWindowsIdentity");
                return GetS2SClientContextWithWindowsIdentity(sharepointUrl, null);
            }

            Trace.WriteLine("CreateAcsClientContextForUrl");
            return CreateAcsClientContextForUrl(properties, sharepointUrl);
        }
        ...
        private static ClientContext CreateAcsClientContextForUrl(SPRemoteEventProperties properties, Uri sharepointUrl)
        {
            ...
            {
                Trace.WriteLine("Context token string is null!!!");
                return null;
            }
